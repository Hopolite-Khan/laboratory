...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="row" id="FirstStep">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12  mb-2 ">
                    <a href="{{ route('PatientRegistration') }}" class="btn w-100 px-12"
                        style="background-color:#4a3aae;color:white;">
                        @svg('plus')
                            ...
                            @foreach ($PATIENTS as $PATIENT)
                                <tr style="display:none;" id="tr_{{ $PATIENT->id }}">
                                    ...
                                    <td><button type="button" class="btn btn-primary " data-bs-toggle="modal"
                                            data-bs-target="#large"> Add Test </button></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            <div class="row mt-2">
                <div class="col d-flex justify-content-end">
                    <button type="submit" id='first_next' onclick="FirstStep()" class="btn"
                        style="background-color:#4a3aae;color:white; border-radius:5px; " disabled> NEXT</button>
                    <button type="submit" id='second_next_back' class="btn mx-2"
                        style="background-color:#4a3aae;color:white; border-radius:5px;  display:none;"
                        onclick="FirstStepBack()"> PREVIOUS</button>
                    <a id='third_next_back' class="btn mx-2"
                        style="background-color:#4a3aae;color:white; border-radius:5px; display:none;"
                        onclick="SecondStepBack();"> PREVIOUS</a>
                    <button type="button" class="btn btn-primary " id='third_next' data-bs-toggle="modal"
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="form-group position-relative has-icon-right">
                                <input type="text" class="form-control" name="test_name_search"
    ...
    <div class="modal fade text-left" id="large1" tabindex="-1" aria-labelledby="myModalLabel17"
        style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <table class="table mt-3 bg-white" id="searchTab">
                        ...
                        <tbody id="BookingQuotationTbody">
                            <tr colspan='2'>
                                ...
                                <td class="fw-bold" id="total_price_td"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                if (tests) {
                    ...
                    xhr.onload = function() {
                        ...
                        for (var count = 0; count < result.length; count++) {
                            HTML +=
                                '<button type="button" class="list-group-item text-start" onclick = "ActivateNewTest(' +
                                result[count].id + ',`' + result[count].test_name + '`,' + result[count].test_price +
                                ')   ">';
                    ...
                    xhr.onload = function() {
                        ...
                        var HTML = '';
                        for (var count = 0; count < result.length; count++) {
                            HTML += ' <button type="button" onclick = "PutPatientIdToHiddenField(' + result[count].id +
                                ',`' + result[count].full_name + ' - ' + result[count].mobile +
