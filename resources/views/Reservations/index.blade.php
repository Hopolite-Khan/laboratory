        ...
        <div class="card-body d-flex justify-content-between">
            ...
            <div>
                <a href="{{ route('ReservationsRegistration') }}" class="btn btn-outline-primary  my-2" title=" ">
                    <svg width="30" height="30" viewBox="0 0 490 490" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M227.8 174.1V227.8H174.1C164.6 227.8 156.9 235.5 156.9 245C156.9 254.5 164.6 262.2 174.1 262.2H227.8V315.9C227.8 325.4 235.5 333.1 245 333.1C254.5 333.1 262.1 325.4 262.1 315.9V262.2H315.8C325.3 262.2 333 254.5 333 245C333 235.5 325.3 227.8 315.8 227.8H262.1V174.1C262.1 164.6 254.4 156.9 245 156.9C235.6 156.9 227.8 164.6 227.8 174.1Z"
                            fill="black" />
                        <path
                            d="M71.7 71.7C25.5 118 0 179.5 0 245C0 310.5 25.5 372 71.8 418.3C118 464.5 179.6 490 245 490C310.4 490 372 464.5 418.3 418.2C464.5 372 490 310.4 490 245C490 179.6 464.5 118 418.2 71.7C372 25.5 310.5 0 245 0C179.6 0 118 25.5 71.7 71.7ZM455.7 245C455.7 301.3 433.8 354.2 394 394C354.2 433.8 301.3 455.7 245 455.7C188.7 455.7 135.8 433.8 96 394C56.2 354.2 34.3 301.3 34.3 245C34.3 188.7 56.2 135.8 96 96C135.8 56.2 188.7 34.3 245 34.3C301.3 34.3 354.2 56.2 394 96C433.8 135.8 455.7 188.7 455.7 245Z"
                            fill="black" />
                    </svg>
                    Reservation
                </a>
